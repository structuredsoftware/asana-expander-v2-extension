...
- Expand additional project field controls, including inherited fields and custom-field "show more" actions
- Scope story-feed comment expansion to collapsed state only
